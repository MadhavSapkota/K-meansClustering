...
#1.*************************DATA DOWNLOAD****************
	!wget -O weather-stations20140101-20141231.csv
...
#****************************DATASET LOADING***********************
#2.Import the .csv to create the columns for year, month and day.
	import csv
	import pandas as pd
	import numpy as np
...
#8. *******************VISUALIZATION OF CLUSTERS BASED ON LOCATION AND MEAN ,MAX AND MIN TEMPERATURE*************
from mpl_toolkits.basemap import Basemap
import matplotlib.pyplot as plt
from pylab import rcParams
%matplotlib inline
